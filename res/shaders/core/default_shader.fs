...
void main()
{
    ...
    // unpack light block data
    vec3 ambient_color = ambient_color_intensity.rgb;
    float ambient_intensity = ambient_color_intensity.w;
    int light_count = light_count_misc.x;
    ...
    // sun poop
    {
        ...
        float sun_intensity = sun_color_intensity.w;
        ...
        vec3 ambient = mat_diffuse * mat_diffuse_color * ambient_color * ambient_intensity;
    ...
    for (int i = 0; i < light_count; ++i)
    {
        ...
        float light_type      = light.params.x; // 0 = point, 1 = directional (gotta do that)
